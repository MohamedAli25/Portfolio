...
<head>
  <title>CardBoard &mdash; Website Template by Colorlib</title>
  <meta charset="utf-8">
...
<body>
  ...
  <header role="banner">
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container-fluid">
        <p class="navbar-brand">Web Team</p>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample05">
          <ul class="navbar-nav pl-md-5 ml-auto">
            <li class="nav-item">
              <a class="nav-link active" href="#header">Header</a>
            </li>
            <li class="nav-item">
  ...
  <div class="slider-item overlay" data-stellar-background-ratio="0.5"
    style="background-image: url('/images/hero_2.jpg');" id="header">
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center">
        <div class="col-lg-12 text-center col-sm-12">
          {{-- <p data-aos="fade-up" data-aos="fade-up" data-aos-delay="">A website template by Colorlib</p> --}}
    ...
    <div class="container">
      <div class="row mb-5 justify-content-center" data-aos="fade-up">
        <div class="col-md-8 text-center">
          <h2 class="mb-4 section-title">Our Work</h2>
          <p>This is a sample of our work</p>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 order-1">
          <figure class="img-dotted-bg">
            ...
            <img src="images/work_1.jpg" alt="Image" class="img-fluid img-absolute" data-aos="fade-left">
